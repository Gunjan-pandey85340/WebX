    ...
    <nav className="navbar">
      <div className="navbar-content">
        ...
        <div className="logo-section">
          <Link to="/">
            <CalendarHeart size={28} className="logo-icon" />
          </Link>
          <h1 className="logo-title">EventSphere</h1>
        </div>

        <div className="nav-links">
          <Link to="/" className="nav-link">Home</Link>
          <Link to="/buy" className="nav-link">Explore</Link>
          <Link to="/sell" className="nav-link">Host</Link>
          <a href="#HavenBot" className="nav-link">MyTickets</a>
          <Link to="/About" className="nav-link">Calendar</Link>
        </div>
